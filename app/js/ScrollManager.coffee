...
class ScrollManager extends ScrollManagerSingleton
  constructor: ->
    ...
    @index        = -1
    @pagesOffsets = []
    @keyArray     = [PagesTypes.INTRO, PagesTypes.MENU, PagesTypes.CONTROL,PagesTypes.REALTIME, PagesTypes.DATA , PagesTypes.GROUPS,PagesTypes.KEEP,PagesTypes.CONTACT ,PagesTypes.FOOTER]
